...
func main() {
	...
	var pidFile string
	var detach bool
	flag.StringVar(&socketLogPath, "socket-log", "/var/run/external-logging.sock", "path to fd logging socket. Created and passed to logging container. Existing socket will be removed.")
